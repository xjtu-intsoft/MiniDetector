...
module.exports = function(e) {
  ...
  ***************************************************************************** */    var r = function(t, e) {
    ...
    function b(e) {
        if (e && "object" == t(e)) return "__luckyOb__" in e ? e.__luckyOb__ : new y(e);
    }
    function w(t, e, i) {
        ...
        if (!r || !1 !== r.configurable) {
            ...
            Object.defineProperty(t, e, {
                ...
                set: function(e) {
                    e !== i && (i = e, o && !a || (a ? a.call(t, e) : i = e, s = b(e), n.notify()));
                }
            });
        }
    }
    var x = 0, k = function() {
        ...
        return t.prototype.get = function() {
            ...
            return this.deep && function(t) {
                !function t(e) {
                    l(e, "array", "object") && Object.keys(e).forEach(function(i) {
                        var n = e[i];
                        t(n);
                    });
                }(t);
        ...
        e.prototype.conversionAxis = function(t, e) {
            ...
            return l(t, "number") ? t : l(t, "string") ? this.changeUnits(t) : 0;
        ...
        var i = -t / e;
        return [ i, -i * t + e ];
    }, C = function t(e, i, n, r, o, a) {
        var s;
        if (void 0 === a && (a = !0), Math.abs(o - r).toFixed(8) >= I(180).toFixed(8)) {
            var u = (o + r) / 2;
            return a ? (t(e, i, n, r, u, a), t(e, i, n, u, o, a)) : (t(e, i, n, u, o, a), t(e, i, n, r, u, a)), 
            !1;
        }
        a || (r = (s = [ o, r ])[0], o = s[1]);
        var c = z(r, n), l = c[0], h = c[1], f = z(o, n), d = f[0], p = f[1], g = T(l, h), v = g[0], m = g[1], y = T(d, p), b = y[0], w = y[1], x = (w - m) / (v - b), k = (b * m - v * w) / (b - v);
        isNaN(x) && (Math.abs(l) === +n.toFixed(8) && (x = l), Math.abs(d) === +n.toFixed(8) && (x = d)), 
        v === 1 / 0 || v === -1 / 0 ? k = b * x + w : b !== 1 / 0 && b !== -1 / 0 || (k = v * x + m), 
        i.lineTo(l, h), e.indexOf("MP") > 0 ? i.quadraticCurveTo(x, k, d, p) : i.arcTo(x, k, d, p, n);
        ...
        return o(e, t), e.prototype.initData = function(t) {
            ...
            this.prizeRadius = this.blocks.reduce(function(t, e, n) {
                ...
                o.fill()), e.imgs && e.imgs.forEach(function(e, r) {
                    if (i.blockImgs[n]) {
                        ...
                        if (a) {
                            var s = i.computedWidthAndHeight(a, e, 2 * t, 2 * t), u = s[0], c = s[1], l = [ i.getOffsetX(u), i.getHeight(e.top, 2 * t) - t ], h = l[0], f = l[1];
                            o.save(), e.rotate && o.rotate(I(i.rotateDeg)), i.drawImage(a, h, f, u, c), o.restore();
                        }
                    }
            ...
            var u = I(-90 + this.rotateDeg + a.offsetDegree), c = function(t) {
            ...
            o.save(), this.prizes.forEach(function(t, e) {
                ...
                f(p) && function(t, e, i, n, r, o, a, s) {
                    a ? function(t, e, i, n, r, o, a, s) {
                        i || (i = a);
                        var u = I(90 / Math.PI / n * a), c = I(90 / Math.PI / i * a), l = r + u, h = o - u, f = r + c, d = o - c;
                        e.beginPath(), e.fillStyle = s, e.moveTo.apply(e, z(l, n)), C(t, e, n, l, h, !0), 
                        d > f ? C(t, e, i, f, d, !1) : e.lineTo.apply(e, z((r + o) / 2, a / 2 / Math.abs(Math.sin((r - o) / 2)))), 
                        e.closePath(), e.fill();
                ...
                o.translate(g, v), o.rotate(n + I(90)), t.imgs && t.imgs.forEach(function(t, n) {
                    if (i.prizeImgs[e]) {
                        var r = i.prizeImgs[e][n];
                        if (r) {
                            var o = i.computedWidthAndHeight(r, t, i.prizeRadian * i.prizeRadius, d), a = o[0], s = o[1], u = [ i.getOffsetX(a), i.getHeight(t.top, d) ], c = u[0], l = u[1];
                            i.drawImage(r, c, l, a, s);
                        }
                    }
                    ...
                    if (Object.prototype.hasOwnProperty.call(t, "wordWrap") ? t.wordWrap : s.wordWrap) {
                        ...
                        for (var g = "", v = 0; v < p.length; v++) {
                            g += p[v];
                            var m = o.measureText(g).width, y = (i.prizeRadius - l(t, d, f.length)) * Math.tan(i.prizeRadian / 2) * 2 - i.getLength(a.gutter);
                            m > i.getWidth(t.lengthLimit || s.lengthLimit, y) && (f.push(g.slice(0, -1)), g = p[v]);
                        }
                    ...
                    f.filter(function(t) {
                        ...
                        o.fillText(e, c(e), l(t, d, i));
                    });
                }), o.rotate(I(360) - n - I(90)), o.translate(-g, -v);
                ...
                o.closePath(), o.fill()), t.imgs && t.imgs.forEach(function(t, r) {
                    if (i.btnImgs[e]) {
                        var o = i.btnImgs[e][r];
                        if (o) {
                            var a = i.computedWidthAndHeight(o, t, 2 * n, 2 * n), s = a[0], u = a[1], c = [ i.getOffsetX(s), i.getHeight(t.top, n) ], l = c[0], h = c[1];
                            i.drawImage(o, l, h, s, u);
                        }
                    }
                }), t.fonts && t.fonts.forEach(function(t) {
            ...
            if (s >= a.accelerationTime && void 0 !== n) {
                ...
                for (var u = (Math.random() * r - r / 2) * this.getLength(a.stopRange), c = 0; ++c; ) {
                    var l = 360 * c - n * r - o - a.offsetDegree + u;
                    if (E[a.speedFunction].easeOut(this.FPS, this.stopDeg, l, a.decelerationTime) - this.stopDeg > a.speed) {
                        this.endDeg = l;
                        break;
                    }
                }
            ...
            return void 0 === e && (e = this.prizeRadian * this.prizeRadius), l(t, "number") ? t : l(t, "string") ? this.changeUnits(t, e) : 0;
        }, e.prototype.getHeight = function(t, e) {
            return void 0 === e && (e = this.prizeRadius), l(t, "number") ? t : l(t, "string") ? this.changeUnits(t, e) : 0;
        ...
        return o(e, t), e.prototype.initData = function(t) {
            ...
            this.cells.forEach(function(t) {
                ...
                var n = t.x, r = t.y, a = t.w, u = t.h, c = function(t) {
                    ...
                    for (var u in s) s[u] = Object.prototype.hasOwnProperty.call(t, u) && l(t[u], "string", "number") ? ~~String(t[u]).replace(/px/g, "") : s[u];
                    return [ n, r, o, a ];
                }(e), h = c[0], d = c[1], p = c[2], g = c[3], v = e.borderRadius ? i.getLength(e.borderRadius) : 0, m = e.background || s.background;
            ...
            this.cellHeight = (this.prizeArea.h - a.gutter * (this.rows - 1)) / this.rows, this.cells.forEach(function(t, e) {
                var n = i.getGeometricProperty([ t.x, t.y, t.col, t.row ]), a = n[0], c = n[1], l = n[2], d = n[3], p = !1;
                ...
                if (f(g)) {
                    ...
                    o.shadowBlur = v[2], v[0] > 0 ? l -= v[0] : (l += v[0], a -= v[0]), v[1] > 0 ? d -= v[1] : (d += v[1], 
                    c -= v[1])), O(o, a, c, l, d, i.getLength(t.borderRadius ? t.borderRadius : s.borderRadius), i.handleBackground(a, c, l, d, g)), 
                ...
                e >= i.prizes.length && (m = "btnImgs", e -= i.prizes.length), t.imgs && t.imgs.forEach(function(n, r) {
                    if (i[m][e]) {
                        ...
                        if (o) {
                            ...
                            if (s) {
                                var u = i.computedWidthAndHeight(s, n, t), l = u[0], h = u[1], f = [ a + i.getOffsetX(l, t.col), c + i.getHeight(n.top, t.row) ], d = f[0], g = f[1];
                                i.drawImage(s, d, g, l, h);
                            }
                        }
                    }
                }), t.fonts && t.fonts.forEach(function(e) {
                    var n = p && u.fontStyle ? u.fontStyle : e.fontStyle || s.fontStyle, r = p && u.fontWeight ? u.fontWeight : e.fontWeight || s.fontWeight, l = p && u.fontSize ? i.getLength(u.fontSize) : i.getLength(e.fontSize || s.fontSize), f = p && u.lineHeight ? u.lineHeight : e.lineHeight || s.lineHeight || e.fontSize || s.fontSize;
                    o.font = r + " " + (l >> 0) + "px " + n, o.fillStyle = p && u.fontColor ? u.fontColor : e.fontColor || s.fontColor;
            ...
            return r.includes("linear-gradient") && (r = function(t, e, i, n, r, o) {
                ...
                var l = t.createLinearGradient.apply(t, u.map(function(t) {
                    return t >> 0;
                }));
            ...
            if (u >= s.accelerationTime && void 0 !== o) {
                ...
                for (var c = 0; ++c; ) {
                    var l = r.length * c + o - (n >> 0);
                    if (P.easeOut(this.FPS, this.stopIndex, l, s.decelerationTime) - this.stopIndex > s.speed) {
                        this.endIndex = l;
                        break;
                    }
                }
            ...
            return void 0 === e && (e = 1), l(t, "number") ? t : l(t, "string") ? this.changeUnits(t, this.cellWidth * e + this._defaultConfig.gutter * (e - 1)) : 0;
        }, e.prototype.getHeight = function(t, e) {
            return void 0 === e && (e = 1), l(t, "number") ? t : l(t, "string") ? this.changeUnits(t, this.cellHeight * e + this._defaultConfig.gutter * (e - 1)) : 0;
    ...
    Component({
        ...
        ready: function() {
            ...
            wx.createSelectorQuery().in(this).select("#lucky-grid").fields({
                ...
                if (e[0] && e[0].node) {
                    ...
                    i.width = e[0].width * o, i.height = e[0].height * o, a.scale(o, o), t.$lucky = new n.LuckyGrid({
                        flag: "MP-WX",
                        ctx: a,
                        dpr: o,
                        width: e[0].width,
        ...
        methods: {
            ...
            imgBindloadActive: function(t) {
                var e = t.currentTarget.dataset, i = e.name, n = e.index, o = e.i, a = this.data[i][n].imgs[o];
                (0, r.resolveImage)(t, a, this.canvas, "activeSrc", "$activeResolve");
            },
            ...
            toPlay: function(t, e) {
                ...
                this.data.buttons.forEach(function(r) {
                    r && (n.beginPath(), n.rect.apply(n, i.$lucky.getGeometricProperty([ r.x, r.y, r.col || 1, r.row || 1 ])), 
                    n.isPointInPath(t * i.dpr, e * i.dpr) && (i.showCanvas = !0, i.setData({
                        luckyImg: ""
                    }), i.$lucky.startCallback()));
                });
            },
            play: function() {
                var t;
