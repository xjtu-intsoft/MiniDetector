...
var t, e, i, n = require("../../@babel/runtime/helpers/typeof");

module.exports = (t = {}, i = function(e, i) {
    if (!t[e]) return require(i);
    if (!t[e].status) {
        var r = t[e].m;
        ...
        o && o.configurable && Object.defineProperty(r, "exports", {
            set: function(t) {
                "object" === n(t) && t !== r._exports && (r._exports.__proto__ = t.__proto__, Object.keys(t).forEach(function(e) {
                    r._exports[e] = t[e];
                })), r._tempexports = t;
            },
            get: function() {
...
})(1624849341028, function(t, e, i) {
    e.exports = t("./dist/lucky-canvas.cjs.min.js");
}, function(t) {
    return i({
        "./dist/lucky-canvas.cjs.min.js": 1624849341029
    }[t], t);
}), e(1624849341029, function(t, e, i) {
    ...
    ***************************************************************************** */    var r = function(t, e) {
    ...
    var c = function(t) {
        ...
        return "string" == typeof t && ("transparent" !== (t = t.toLocaleLowerCase().trim()) && (!/^rgba/.test(t) || 0 !== (null === (e = /([^\s,]+)\)$/.exec(t)) ? 0 : "object" == n(e) ? NaN : "number" == typeof e ? e : "string" == typeof e ? "%" === e[e.length - 1] ? Number(e.slice(0, -1)) / 100 : Number(e) : NaN)));
        var e;
    }, d = function() {
        function t() {
            this.subs = [];
    ...
    var m = Array.prototype, v = Object.create(m);
    [ "push", "pop", "shift", "unshift", "sort", "splice", "reverse" ].forEach(function(t) {
        v[t] = function() {
            for (var e = [], i = 0; i < arguments.length; i++) e[i] = arguments[i];
            var n = m[t].apply(this, e), r = this.__luckyOb__;
    ...
    var b = function() {
        function t(t) {
            this.dep = new d(), g(t, "__luckyOb__", this), Array.isArray(t) && (p ? t.__proto__ = v : Object.getOwnPropertyNames(v).forEach(function(e) {
                g(t, e, v[e]);
            })), this.walk(t);
        }
    ...
    function y(t) {
        if (t && "object" == n(t)) return "__luckyOb__" in t ? t.__luckyOb__ : new b(t);
    }
    function w(t, e, i) {
        ...
        if (!r || !1 !== r.configurable) {
            ...
            Object.defineProperty(t, e, {
                get: function() {
                    var e = o ? o.call(t) : i;
                    return d.target && (n.addSub(d.target), a && a.dep.addSub(d.target)), e;
                },
                set: function(e) {
    ...
    var x = 0, z = function() {
        ...
        return t.prototype.get = function() {
            ...
            return this.deep && function(t) {
                !function t(e) {
                    c(e, "array", "object") && Object.keys(e).forEach(function(i) {
                        var n = e[i];
                        t(n);
                    });
                }(t);
        ...
        }, t.prototype.handleClick = function(t) {}, t.prototype.handleMouseDown = function(t) {}, 
        t.prototype.handleMouseUp = function(t) {}, t.prototype.handleMouseMove = function(t) {}, 
        t.prototype.conversionAxis = function(t, e) {
            ...
            var t = this.config, e = this.ctx, i = t.canvasElement, n = t.dpr, r = [ this.boxWidth * n, this.boxHeight * n ], o = r[0], s = r[1], a = function(t) {
                return (t * n - t) / (t * n) * (n / 2) * 100;
            };
            i && (i.width = o, i.height = s, i.style.width = o + "px", i.style.height = s + "px", 
            i.style.transform = "scale(" + 1 / n + ") translate(" + -a(o) + "%, " + -a(s) + "%)", 
            e.scale(n, n));
            ...
            return [ "WEB", "MP-WX" ].includes(s.flag) ? o = t : [ "UNI-H5", "UNI-MP", "TARO-H5", "TARO-MP" ].includes(s.flag) && (o = t.path), 
            a.drawImage(o, e, i, n, r);
        }, t.prototype.getLength = function(t) {
            return c(t, "number") ? t : c(t, "string") ? this.changeUnits(t) : 0;
            ...
            void 0 === i && (i = {}), "object" == n(e) && (e = (i = e).handler);
            var r = new z(this, t, e, i);
        ...
        var a;
        if (void 0 === s && (s = !0), Math.abs(o - r).toFixed(8) >= k(180).toFixed(8)) {
            var u = (o + r) / 2;
            return s ? (t(e, i, n, r, u, s), t(e, i, n, u, o, s)) : (t(e, i, n, u, o, s), t(e, i, n, r, u, s)), 
            !1;
        }
        s || (r = (a = [ o, r ])[0], o = a[1]);
        var h = S(r, n), c = h[0], l = h[1], f = S(o, n), d = f[0], p = f[1], g = C(c, l), m = g[0], v = g[1], b = C(d, p), y = b[0], w = b[1], x = (w - v) / (m - y), z = (y * v - m * w) / (y - m);
        isNaN(x) && (Math.abs(c) === +n.toFixed(8) && (x = c), Math.abs(d) === +n.toFixed(8) && (x = d)), 
        m === 1 / 0 || m === -1 / 0 ? z = y * x + w : y !== 1 / 0 && y !== -1 / 0 || (z = m * x + v), 
        i.lineTo(c, l), e.indexOf("MP") > 0 ? i.quadraticCurveTo(x, z, d, p) : i.arcTo(x, z, d, p, n);
    }, _ = function(t, e, i, n, r, o, s) {
        var a = Math.min(n, r);
        o > a / 2 && (o = a / 2), t.beginPath(), t.fillStyle = s, t.moveTo(e + o, i), t.lineTo(e + o, i), 
        ...
        return o(e, t), e.prototype.initData = function(t) {
            ...
            var o = this.config, s = this.ctx;
            this.Radius = Math.min(this.boxWidth, this.boxHeight) / 2, null === (i = o.beforeInit) || void 0 === i || i.call(this), 
            s.translate(this.Radius, this.Radius), this.draw(), this.draw(), Object.keys(e).forEach(function(t) {
                var i = t, n = {
                    blockImgs: "blocks",
                    prizeImgs: "prizes",
                    btnImgs: "buttons"
            ...
            return a(this, void 0, void 0, function() {
                ...
                return u(this, function(u) {
                    return (o = this[t][e]) && o.imgs && (s = o.imgs[n]) ? (this[i][e] || (this[i][e] = []), 
                    this.loadImg(s.src, s).then(function(t) {
                        a[i][e][n] = t, r.call(a);
                    }).catch(function(i) {
            ...
            this.prizeRadius = this.blocks.reduce(function(t, e, n) {
                ...
                o.fill()), e.imgs && e.imgs.forEach(function(e, r) {
                    if (i.blockImgs[n]) {
                        ...
                        if (s) {
                            var a = i.computedWidthAndHeight(s, e, 2 * t, 2 * t), u = a[0], h = a[1], c = [ i.getOffsetX(u), i.getHeight(e.top, 2 * t) - t ], l = c[0], f = c[1];
                            o.save(), e.rotate && o.rotate(k(i.rotateDeg)), i.drawImage(s, l, f, u, h), o.restore();
                        }
                    }
                }), t - i.getLength(e.padding && e.padding.split(" ")[0]);
            }, this.Radius), this.prizeDeg = 360 / this.prizes.length, this.prizeRadian = k(this.prizeDeg);
            var u = k(-90 + this.rotateDeg + s.offsetDegree), h = function(t) {
            ...
            o.save(), this.prizes.forEach(function(t, e) {
                var n = u + e * i.prizeRadian, d = i.prizeRadius - i.maxBtnRadius, p = t.background || a.background;
                f(p) && function(t, e, i, n, r, o, s, a) {
                    s ? function(t, e, i, n, r, o, s, a) {
                        i || (i = s);
                        var u = k(90 / Math.PI / n * s), h = k(90 / Math.PI / i * s), c = r + u, l = o - u, f = r + h, d = o - h;
                        e.beginPath(), e.fillStyle = a, e.moveTo.apply(e, S(c, n)), T(t, e, n, c, l, !0), 
                        d > f ? T(t, e, i, f, d, !1) : e.lineTo.apply(e, S((r + o) / 2, s / 2 / Math.abs(Math.sin((r - o) / 2)))), 
                        e.closePath(), e.fill();
                    }(t, e, i, n, r, o, s, a) : (e.beginPath(), e.fillStyle = a, e.moveTo(0, 0), e.arc(0, 0, n, r, o, !1), 
                    e.closePath(), e.fill());
                ...
                o.translate(g, m), o.rotate(n + k(90)), t.imgs && t.imgs.forEach(function(t, n) {
                    if (i.prizeImgs[e]) {
                        var r = i.prizeImgs[e][n];
                        if (r) {
                            var o = i.computedWidthAndHeight(r, t, i.prizeRadian * i.prizeRadius, d), s = o[0], a = o[1], u = [ i.getOffsetX(s), i.getHeight(t.top, d) ], h = u[0], c = u[1];
                            i.drawImage(r, h, c, s, a);
                        }
                    }
                }), t.fonts && t.fonts.forEach(function(t) {
                    var e = t.fontColor || a.fontColor, n = t.fontWeight || a.fontWeight, r = i.getLength(t.fontSize || a.fontSize), u = t.fontStyle || a.fontStyle;
                    ...
                    if (Object.prototype.hasOwnProperty.call(t, "wordWrap") ? t.wordWrap : a.wordWrap) {
                        ...
                        for (var g = "", m = 0; m < p.length; m++) {
                            g += p[m];
                            var v = o.measureText(g).width, b = (i.prizeRadius - c(t, d, f.length)) * Math.tan(i.prizeRadian / 2) * 2 - i.getLength(s.gutter);
                            v > i.getWidth(t.lengthLimit || a.lengthLimit, b) && (f.push(g.slice(0, -1)), g = p[m]);
                        }
                    ...
                    f.filter(function(t) {
                        ...
                        o.fillText(e, h(e), c(t, d, i));
                    });
                }), o.rotate(k(360) - n - k(90)), o.translate(-g, -m);
                ...
                o.closePath(), o.fill()), t.imgs && t.imgs.forEach(function(t, r) {
                    if (i.btnImgs[e]) {
                        var o = i.btnImgs[e][r];
                        if (o) {
                            var s = i.computedWidthAndHeight(o, t, 2 * n, 2 * n), a = s[0], u = s[1], h = [ i.getOffsetX(a), i.getHeight(t.top, n) ], c = h[0], l = h[1];
                            i.drawImage(o, c, l, a, u);
                        }
                    }
                }), t.fonts && t.fonts.forEach(function(t) {
                    var e = t.fontColor || a.fontColor, r = t.fontWeight || a.fontWeight, s = i.getLength(t.fontSize || a.fontSize), u = t.fontStyle || a.fontStyle;
                    o.fillStyle = e, o.font = r + " " + (s >> 0) + "px " + u, String(t.text).split("\n").forEach(function(e, i) {
                        o.fillText(e, h(e), c(t, n, i));
                    });
                });
            ...
            void 0 === t && (t = 0);
            var e = this, i = e.rAF, n = e.prizeFlag, r = e.prizeDeg, o = e.rotateDeg, s = e._defaultConfig, a = Date.now() - this.startTime;
            if (a >= s.accelerationTime && void 0 !== n) {
                ...
                for (var u = (Math.random() * r - r / 2) * this.getLength(s.stopRange), h = 0; ++h; ) {
                    ...
                    if (D[s.speedFunction].easeOut(this.FPS, this.stopDeg, c, s.decelerationTime) - this.stopDeg > s.speed) {
                        this.endDeg = c;
                        break;
                    }
                }
            ...
            this.rotateDeg = (o + D[s.speedFunction].easeIn(a, 0, s.speed, s.accelerationTime)) % 360, 
            this.draw(), i(this.run.bind(this, t + 1));
        }, e.prototype.slowDown = function() {
            var t, e = this, i = e.rAF, n = e.prizes, r = e.prizeFlag, o = e.stopDeg, a = e.endDeg, u = e._defaultConfig, h = Date.now() - this.endTime;
            if (-1 !== r) {
                if (h >= u.decelerationTime) return this.startTime = 0, void (null === (t = this.endCallback) || void 0 === t || t.call(this, s({}, n.find(function(t, e) {
                    return e === r;
                }))));
                this.rotateDeg = D[u.speedFunction].easeOut(h, o, a, u.decelerationTime) % 360, 
                this.draw(), i(this.slowDown.bind(this));
            } else this.startTime = 0;
        }, e.prototype.getWidth = function(t, e) {
            return void 0 === e && (e = this.prizeRadian * this.prizeRadius), c(t, "number") ? t : c(t, "string") ? this.changeUnits(t, e) : 0;
        }, e.prototype.getHeight = function(t, e) {
            return void 0 === e && (e = this.prizeRadius), c(t, "number") ? t : c(t, "string") ? this.changeUnits(t, e) : 0;
        ...
        return o(e, t), e.prototype.initData = function(t) {
            ...
            var i, n, r = this;
            t.prototype.init.call(this);
            var o = this, s = o.config;
            o.ctx, o.button, null === (i = s.beforeInit) || void 0 === i || i.call(this), this.draw(), 
            ...
            h(h([], this.buttons), [ this.button ]).forEach(function(n) {
                var r;
                if (n) {
                    var o = e.getGeometricProperty([ n.x, n.y, n.col || 1, n.row || 1 ]), s = o[0], a = o[1], u = o[2], h = o[3];
                    i.beginPath(), i.rect(s, a, u, h), i.isPointInPath(t.offsetX, t.offsetY) && (e.startTime || ("function" == typeof n.callback && n.callback.call(e, n), 
            ...
            return a(this, void 0, void 0, function() {
                ...
                return u(this, function(u) {
                    ...
                    o && o.imgs && (s = o.imgs[n]) ? (this[i][e] || (this[i][e] = []), a = [ this.loadImg(s.src, s), s.activeSrc && this.loadImg(s.activeSrc, s, "$activeResolve") ], 
            ...
            var t, e, i = this, n = this, r = n.config, o = n.ctx, s = n._defaultConfig, a = n._defaultStyle, u = n._activeStyle;
            null === (t = r.beforeDraw) || void 0 === t || t.call(this, o), o.clearRect(0, 0, this.boxWidth, this.boxHeight), 
            this.cells = h(h([], this.prizes), this.buttons), this.button && this.cells.push(this.button), 
            this.cells.forEach(function(t) {
                t.col = t.col || 1, t.row = t.row || 1;
            }), this.prizeArea = this.blocks.reduce(function(t, e) {
                var n = t.x, r = t.y, s = t.w, u = t.h, h = function(t) {
                    ...
                    for (var u in a) a[u] = Object.prototype.hasOwnProperty.call(t, u) && c(t[u], "string", "number") ? ~~String(t[u]).replace(/px/g, "") : a[u];
                    return [ n, r, o, s ];
                }(e), l = h[0], d = h[1], p = h[2], g = h[3], m = e.borderRadius ? i.getLength(e.borderRadius) : 0, v = e.background || a.background;
                return f(v) && _(o, n, r, s, u, m, i.handleBackground(n, r, s, u, v)), {
                    x: n + p,
                    y: r + l,
                    w: s - p - g,
                    h: u - l - d
            ...
            this.cellHeight = (this.prizeArea.h - s.gutter * (this.rows - 1)) / this.rows, this.cells.forEach(function(t, e) {
                var n = i.getGeometricProperty([ t.x, t.y, t.col, t.row ]), s = n[0], h = n[1], c = n[2], d = n[3], p = !1;
                (void 0 === i.prizeFlag || i.prizeFlag > -1) && (p = e === i.currIndex % i.prizes.length >> 0);
                var g = p ? u.background : t.background || a.background;
                if (f(g)) {
                    var m = (p ? u.shadow : t.shadow || a.shadow).replace(/px/g, "").split(",")[0].split(" ").map(function(t, e) {
                        return e < 3 ? Number(t) : t;
                    });
                    4 === m.length && (o.shadowColor = m[3], o.shadowOffsetX = m[0] * r.dpr, o.shadowOffsetY = m[1] * r.dpr, 
                    o.shadowBlur = m[2], m[0] > 0 ? c -= m[0] : (c += m[0], s -= m[0]), m[1] > 0 ? d -= m[1] : (d += m[1], 
                    h -= m[1])), _(o, s, h, c, d, i.getLength(t.borderRadius ? t.borderRadius : a.borderRadius), i.handleBackground(s, h, c, d, g)), 
                ...
                e >= i.prizes.length && (v = "btnImgs", e -= i.prizes.length), t.imgs && t.imgs.forEach(function(n, r) {
                    if (i[v][e]) {
                        var o = i[v][e][r];
                        if (o) {
                            var a = p && o.activeImg || o.defaultImg;
                            if (a) {
                                var u = i.computedWidthAndHeight(a, n, t), c = u[0], l = u[1], f = [ s + i.getOffsetX(c, t.col), h + i.getHeight(n.top, t.row) ], d = f[0], g = f[1];
                                i.drawImage(a, d, g, c, l);
                            }
                        }
                    }
                }), t.fonts && t.fonts.forEach(function(e) {
                    var n = p && u.fontStyle ? u.fontStyle : e.fontStyle || a.fontStyle, r = p && u.fontWeight ? u.fontWeight : e.fontWeight || a.fontWeight, c = p && u.fontSize ? i.getLength(u.fontSize) : i.getLength(e.fontSize || a.fontSize), f = p && u.lineHeight ? u.lineHeight : e.lineHeight || a.lineHeight || e.fontSize || a.fontSize;
                    o.font = r + " " + (c >> 0) + "px " + n, o.fillStyle = p && u.fontColor ? u.fontColor : e.fontColor || a.fontColor;
                    var d = [], g = String(e.text);
                    if (Object.prototype.hasOwnProperty.call(e, "wordWrap") ? e.wordWrap : a.wordWrap) {
                        g = l(g);
                        for (var m = "", v = 0; v < g.length; v++) m += g[v], o.measureText(m).width > i.getWidth(e.lengthLimit || a.lengthLimit, t.col) && (d.push(m.slice(0, -1)), 
                        m = g[v]);
                        m && d.push(m), d.length || d.push(g);
                    } else d = g.split("\n");
                    d.forEach(function(n, r) {
                        o.fillText(n, s + i.getOffsetX(o.measureText(n).width, t.col), h + i.getHeight(e.top, t.row) + (r + 1) * i.getLength(f));
                    });
                });
            }), null === (e = r.afterDraw) || void 0 === e || e.call(this, o);
            ...
            void 0 === t && (t = 0);
            var e = this, i = e.rAF, n = e.currIndex, r = e.prizes, o = e.prizeFlag, s = e.startTime, a = e._defaultConfig, u = Date.now() - s;
            ...
            this.currIndex = (n + O.easeIn(u, .1, a.speed, a.accelerationTime)) % r.length, 
            this.draw(), i(this.run.bind(this, t + 1));
        }, e.prototype.slowDown = function() {
            var t, e = this, i = e.rAF, n = e.prizes, r = e.prizeFlag, o = e.stopIndex, a = e.endIndex, u = e._defaultConfig, h = Date.now() - this.endTime;
            if (-1 !== r) {
                if (h > u.decelerationTime) return this.startTime = 0, void (null === (t = this.endCallback) || void 0 === t || t.call(this, s({}, n.find(function(t, e) {
                    return e === r;
                }))));
                this.currIndex = O.easeOut(h, o, a, u.decelerationTime) % n.length, this.draw(), 
            ...
            var e = t[0], i = t[1], n = t[2], r = t[3], o = this.cellWidth, s = this.cellHeight, a = this._defaultConfig.gutter, u = [ this.prizeArea.x + (o + a) * e, this.prizeArea.y + (s + a) * i ];
            return n && r && u.push(o * n + a * (n - 1), s * r + a * (r - 1)), u;
        }, e.prototype.getWidth = function(t, e) {
            return void 0 === e && (e = 1), c(t, "number") ? t : c(t, "string") ? this.changeUnits(t, this.cellWidth * e + this._defaultConfig.gutter * (e - 1)) : 0;
        }, e.prototype.getHeight = function(t, e) {
            return void 0 === e && (e = 1), c(t, "number") ? t : c(t, "string") ? this.changeUnits(t, this.cellHeight * e + this._defaultConfig.gutter * (e - 1)) : 0;
