...
!function() {
    ...
    }, d = e.SerializableCipher = i.extend({
        cfg: i.extend({
            format: f
        }),
    ...
    for (var _ = 0, v = 0, y = 0; 256 > y; y++) {
        ...
        n[_] = g, s[g] = _;
        var B = l[_], m = l[B], x = l[m], k = 257 * l[g] ^ 16843008 * g;
        o[_] = k << 24 | k >>> 8, c[_] = k << 16 | k >>> 16, a[_] = k << 8 | k >>> 24, f[_] = k, 
        k = 16843009 * x ^ 65537 * m ^ 257 * B ^ 16843008 * _, h[g] = k << 24 | k >>> 8, 
        u[g] = k << 16 | k >>> 16, p[g] = k << 8 | k >>> 24, d[g] = k, _ ? (_ = B ^ l[l[l[x ^ B]]], 
        v ^= l[l[v]]) : _ = v = 1;
    }
    var S = [ 0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54 ], i = i.AES = e.extend({
        _doReset: function() {
