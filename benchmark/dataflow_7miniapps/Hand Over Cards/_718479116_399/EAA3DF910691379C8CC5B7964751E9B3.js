...
var e = 310, o = "请求参数信息有误", i = 600, a = "系统错误", r = 1e3, n = 200, s = {
    ...
    checkParamKeyEmpty: function(t, i) {
        if (!t[i]) {
            var a = this.buildErrorConfig(e, o + i + "参数格式有误");
            return t.fail(a), t.complete(a), !0;
        }
        return !1;
    },
    ...
    checkLocation: function(t) {
        ...
        if (!i || !i.latitude || !i.longitude) {
            var a = this.buildErrorConfig(e, o + " location参数格式有误");
            return t.fail(a), t.complete(a), !1;
        }
        return !0;
    },
    ...
    buildWxRequestConfig: function(t, e) {
        ...
        return e.header = {
            ...
            e.statusCode = r, t.fail(o.buildErrorConfig(r, e.errMsg));
        }, e.complete = function(e) {
            switch (+e.statusCode) {
              case r:
                t.complete(o.buildErrorConfig(r, e.errMsg));
                break;
              ...
              default:
                t.complete(o.buildErrorConfig(i, a));
            }
        }, e;
    },
    locationProcess: function(t, e, o, i) {
        var a = this;
        (o = o || function(e) {
            e.statusCode = r, t.fail(a.buildErrorConfig(r, e.errMsg));
        }, i = i || function(e) {
            e.statusCode == r && t.complete(a.buildErrorConfig(r, e.errMsg));
        }, t.location) ? a.checkLocation(t) && e(s.getLocationParam(t.location)) : a.getWXLocation(e, o, i);
    }
}, u = function() {
    function e(t) {
        if (function(t, e) {
    ...
    return t(e, [ {
        ...
        value: function(t) {
            if (t = t || {}, s.polyfillParam(t), s.checkKeyword(t)) {
                ...
                s.locationProcess(t, function(a) {
                    e.boundary = "nearby(" + a.latitude + "," + a.longitude + "," + o + "," + i + ")", 
