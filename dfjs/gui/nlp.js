...
const privacy_path = "D:\\WORK\\2022\\mpdf_dev\\mpdf-df\\gui\\dict\\privacy_v2.json"
...
// const text = "读取您的手机号、昵称和头像性别、地区信息"
// const method = "cosine"
// const threshold = 0.3
// const text_tp = getType(text, method, threshold, false)
// console.log(text_tp)
// console.log((StrSimilarity("读取您的手机号、昵称和头像性别、地区信息", "税号", "overlap")))
// console.log(jieba.cut("fullname", true))
// module.exports = {
//     getType
// }